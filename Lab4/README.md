...
|                | Loopback0     | 10.1.255.15     | 255.255.255.255 | Loopback для управления и маршрутизации      |
...
|                | e0/1          | 198.19.1.2     | 255.255.255.252 | Соединение с AS 101 (R22)                    |
...
|                | Loopback0     | 10.52.255.23    | 255.255.255.255   | Loopback для управления и маршрутизации|
...
|                | Loopback0     | 10.52.255.24    | 255.255.255.255   | Loopback для управления и маршрутизации|
...
|                | Loopback0     | 10.52.255.25    | 255.255.255.255   | Loopback для управления и маршрутизации|
...
|                | Loopback0     | 10.52.255.26    | 255.255.255.255   | Loopback для управления и маршрутизации|
